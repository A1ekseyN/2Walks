...
class Equipment():
    ...
    def equipment_view(self):
        ...
        if char_characteristic['equipment_head'] == None and char_characteristic['equipment_neck'] == None and char_characteristic['equipment_torso'] == None and char_characteristic['equipment_finger_01'] == None and char_characteristic['equipment_finger_02'] == None and char_characteristic['equipment_legs'] == None and char_characteristic['equipment_foots'] == None:
            print('\nНа персонаже нет вещей: ')

        if char_characteristic['equipment_head'] != None:
            print(f'1. Голова:            {char_characteristic["equipment_head"]}')
        elif char_characteristic['equipment_head'] == None:
            print('1. Голова:            Нет одежды')

        if char_characteristic['equipment_neck'] != None:
            print(f'2. Шея:               {char_characteristic["equipment_neck"]["item_name"][0].title()} {char_characteristic["equipment_neck"]["grade"][0].title()}: + {char_characteristic["equipment_neck"]["bonus"][0]} {char_characteristic["equipment_neck"]["characteristic"][0].title()} (Quality: {char_characteristic["equipment_neck"]["quality"][0]})')
        elif char_characteristic['equipment_neck'] == None:
            print('2. Шея:               Нет одежды')

        if char_characteristic['equipment_torso'] != None:
            print(f'3. Торс:              {char_characteristic["equipment_torso"]}')
        elif char_characteristic['equipment_torso'] == None:
            print('3. Торс:              Нет одежды')

        if char_characteristic['equipment_finger_01'] != None:
            print(f'4. Палец левой руки:  {char_characteristic["equipment_finger_01"]["item_name"][0].title()} {char_characteristic["equipment_finger_01"]["grade"][0].title()}: + {char_characteristic["equipment_finger_01"]["bonus"][0]} {char_characteristic["equipment_finger_01"]["characteristic"][0].title()} (Quality: {char_characteristic["equipment_finger_01"]["quality"][0]})')
        ...
        if char_characteristic['equipment_finger_02'] != None:
            print(f'5. Палец правой руки: {char_characteristic["equipment_finger_02"]["item_name"][0].title()} {char_characteristic["equipment_finger_02"]["grade"][0].title()}: + {char_characteristic["equipment_finger_02"]["bonus"][0]} {char_characteristic["equipment_finger_02"]["characteristic"][0].title()} (Quality: {char_characteristic["equipment_finger_02"]["quality"][0]})')
    ...
    def change_item_in_slot(self, item_name, item_type, item_slot, list_cnt):
        ...
        try:
            ...
            if index in list_cnt:
                print(f'\nВы выбрали предмет:'
                      f'\n- {char_characteristic["inventory"][index - 1]["item_name"][0].title()} {char_characteristic["inventory"][index - 1]["grade"][0].title()}: + {char_characteristic["inventory"][index - 1]["bonus"][0]} {char_characteristic["inventory"][index - 1]["characteristic"][0].title()} (Quality: {char_characteristic["inventory"][index - 1]["quality"][0]}).')
                try:
                    ...
                    if ask == '1':
                        ...
                        print(f'- {char_characteristic[item_slot]["item_name"][0].title()} {char_characteristic[item_slot]["grade"][0].title()}: + {char_characteristic[item_slot]["bonus"][0]} {char_characteristic[item_slot]["characteristic"][0].title()} (Quality: {char_characteristic[item_slot]["quality"][0]})')
