...
_SKILL_DESCRIPTIONS = {
    ...
    'forge_steps_saving': (
        'Кузница: экономия шагов',
        'forge_steps_saving',
        'Каждый уровень снижает расход шагов в Кузнице (ремонт + крафт) на 1%. '
        'Прокачка до 1 уровня разблокирует локацию Кузница.',
    ),
    'forge_money_saving': (
        'Кузница: экономия золота',
        'forge_money_saving',
        'Каждый уровень снижает расход золота в Кузнице (ремонт + крафт) на 1%. '
        'Прокачка до 1 уровня разблокирует локацию Кузница.',
    ),
    'forge_repair_quality': (
        'Кузница: качество ремонта',
        'forge_repair_quality',
        'Каждый уровень увеличивает восстановленное качество за ремонт на 1% '
        '(множитель ×(1 + lvl/100): на 10 lvl ремонт 1% даёт +1.1% качества). '
        'Прокачка до 1 уровня разблокирует локацию Кузница.',
    ),
    'forge_speed': (
        'Кузница: скорость работы',
        'forge_speed',
        'Каждый уровень сокращает длительность ремонта и крафта на 1% '
        '(линейно, минимум 1 минута). Прокачка до 1 уровня разблокирует '
        'локацию Кузница.',
    ),
}
...
def gym_menu(state: GameState) -> None:
    ...
    skill_options = {
        ...
        '21': ('forge_steps_saving', 'Кузница: экономия шагов:          ',
               state.gym.forge_steps_saving + 1),
        '22': ('forge_money_saving', 'Кузница: экономия золота:         ',
               state.gym.forge_money_saving + 1),
        '23': ('forge_repair_quality', 'Кузница: качество ремонта:        ',
               state.gym.forge_repair_quality + 1),
        '24': ('forge_speed', 'Кузница: скорость работы:         ',
               state.gym.forge_speed + 1),
    }
