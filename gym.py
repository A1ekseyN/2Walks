...
def gym_menu(state: GameState) -> None:
    ...
    skill_options = {
        ...
        '11': ('trader', 'Торговец:                         ',
               state.gym.trader + 1),
        '12': ('banking_interest_rate', 'Банковская ставка:                ',
               state.gym.banking_interest_rate + 1),
        '13': ('loan_capacity', 'Кредитный лимит:                  ',
               state.gym.loan_capacity + 1),
        '14': ('loan_interest_reduction', 'Снижение ставки по кредиту:       ',
               state.gym.loan_interest_reduction + 1),
        '15': ('inspiration', 'Обучение:                         ',
               state.gym.inspiration + 1),
        '16': ('backpack_skill', 'Размер инвентаря:                 ',
