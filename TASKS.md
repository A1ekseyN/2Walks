...
### 4.59. Кузница / Blacksmith (зонтичная — Repair + Crafting + Gems) `[M / L / partial — MVP done (4.59.0 infra + 4.59.1 Repair + 4.59.2 Crafting, 0.2.4o); остался 4.59.3 Gems (deferred low-priority)]`
