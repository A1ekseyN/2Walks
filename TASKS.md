...
### 4.54. Sync resolution: CLI ↔ Web `[H / M / todo (дизайн зафиксирован 15.05.2026, блокирует 4.48.0.1 deploy)]`
...
#### 4.54.7. Tests `[H / S / todo (blocked by 4.54.5, 4.54.6)]`
...
#### 4.54.8. Bake test + docs `[H / XS / todo (blocked by 4.54.7)]`
