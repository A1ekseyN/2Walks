...
class CharLevel:
    ...
    def view_total_used_steps(self) -> None:
        print(f"total_used_steps: {self.total_used_steps}")

    def view_char_level(self) -> None:
        print(f"level: {self.level}")

    def update_level_char_characteristic(self) -> None:
    ...
    def update_level_up_skills_char_characteristic(self, level_up_difference: int) -> None:
    ...
    def progress_bar(self, length: int = 33) -> str:
    ...
    def progress_bar_lvl_up_message(self) -> str:
